...
$(document).ready(function () {
    ...
    $SIDEBAR_MENU.find("a").on("click", function (t) {
        ...
        $MENU_TOGGLE.on("click", function () {
            ;(ico = document.querySelector("#ico_home").style.display),
                (img = document.querySelector("#img_home").style.display),
                (document.querySelector("#ico_home").style.display = img),
                (document.querySelector("#img_home").style.display = ico),
