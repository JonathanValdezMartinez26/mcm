...
class Validaciones
{
    ...
    public static function VinculaInvitado($datosCliente)
    {
        ...
        INSERT INTO
            CL_PROMO_TELARANA
                (ID_CL_PROMO_TELARANA, CL_INVITA, CDGNS_INVITA, CICLO_INVITACION, CL_INVITADO, FECHA_REGISTRO, FECHA_MODIFICACION, ESTATUS_PAGADO, MONTO_PAGO)
            VALUES
                ((SELECT MAX(ID_CL_PROMO_TELARANA) FROM CL_PROMO_TELARANA)+1, :CL_INVITA, NULL, NULL, :CL_INVITADO, TO_DATE(:FECHA_REGISTRO, 'YYYY-MM-DD'), NULL, NULL, NULL)
        sql;
