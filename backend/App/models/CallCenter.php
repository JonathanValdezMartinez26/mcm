...
sql;
          ...
          $desbloqueo_cl=<<<sql
                SELECT COUNT(ID_SCALL) as LLAMADA_UNO, (DIA_LLAMADA_1_CL ||' '|| TO_CHAR(HORA_LLAMADA_1_CL ,'HH24:MI:SS')) AS HORA_LLAMADA_UNO, (DIA_LLAMADA_2_CL ||' '||TO_CHAR(HORA_LLAMADA_2_CL ,'HH24:MI:SS')) AS HORA_LLAMADA_DOS, NUMERO_INTENTOS_CL, COMENTARIO_INICIAL, COMENTARIO_FINAL, ESTATUS, VOBO_GERENTE_REGIONAL,
                ...
                GROUP BY ID_SCALL, DIA_LLAMADA_1_CL, HORA_LLAMADA_1_CL, PRG_UNO_CL, DIA_LLAMADA_2_CL, HORA_LLAMADA_2_CL, NUMERO_INTENTOS_CL, COMENTARIO_INICIAL, COMENTARIO_FINAL, FIN_CL, COMENTARIO_PRORROGA, PRORROGA, REACTIVACION, ESTATUS, VOBO_GERENTE_REGIONAL          
...
sql;
    ...
    public static function getAllSolicitudesBusquedaRapida($cdgns){
        ...
        WHEN CICLO = 'R2'  THEN 'SE CANCELO/RECHAZO 2 VEZ' 
        WHEN CICLO = 'R3'  THEN 'SE CANCELO/RECHAZO 3 VEZ' 
        WHEN CICLO = 'R4'  THEN 'SE CANCELO/RECHAZO 4 VEZ' 
        WHEN CICLO = 'R5'  THEN 'SE CANCELO/RECHAZO 5 VEZ' 
