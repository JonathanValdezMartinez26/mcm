...
sql;
    ...
    public static function getAllSolicitudesHistoricoExcel($datos)
    {
        ...
        $fecha = "AND TO_DATE(SPR.FECHA_SOL, 'DD/MM/YYYY HH24:MI:SS') BETWEEN TIMESTAMP '{$datos['fechaI']} 00:00:00.000000' AND TIMESTAMP '{$datos['fechaF']} 23:59:59.000000'";
