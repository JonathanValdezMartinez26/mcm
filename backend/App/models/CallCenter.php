...
sql;
    ...
    public static function getAllSolicitudesBusquedaRapida($cdgns){
        ...
        CASE WHEN (ESTATUS_FINAL = 'PENDIENTE' OR ESTATUS_FINAL IS NULL) THEN 'BANDEJA PENDIENTES, VALIDANDO EL EJECUTIVO: ' || EJECUTIVO
        ELSE 'BANDEJA PENDIENTES - SUC: ' || NOMBRE_SUCURSAL END AS BANDEJA
        FROM SOLICITUDES_PROCESADAS SPR WHERE CDGNS = '$cdgns'
sql;
