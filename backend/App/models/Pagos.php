...
class Pagos{
    ...
    public static function ConsultarPagosAdministracion( $noCredito){
        ...
        TRUNC(FREGISTRO) + 10/24 +  0/1440 AS DE,
        TRUNC(FREGISTRO) + 1 + 10/24 +  10/1440 AS HASTA,
        CASE
        WHEN SYSDATE BETWEEN (TRUNC(FECHA) + 10/24 + 0/1440) AND (TRUNC(FECHA) + 1 + 10/24 + 10/1440) THEN 'SI'
        Else 'NO'
        END AS DESIGNATION,
        CASE
        WHEN SYSDATE BETWEEN (TRUNC(FECHA) + 10/24 + 0/1440) AND (TRUNC(FECHA) + 2 + 11/24 + 0/1440) THEN 'SI'
        Else 'NO'
