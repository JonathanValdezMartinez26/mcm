                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 16px;" colspan="5">
                                                    ...
                                                    <div>
                                                        <button type="button" <?php echo $ocultar_boton_l4_iniciar ?> id="boton_iniciar" class="btn btn-primary" style="border: 1px solid #006700; background: #FFFFFF" data-toggle="modal" data-target="#modal_encuesta_cliente" data-backdrop="static" data-keyboard="false" disabled>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-size: 14px;">
                                                                <div style="display:flex; flex-direction:column; max-width: 230px; margin: auto;">
                                                                    $resumen
                                                                    <div>
                                                                        <button type="button" class="btn btn-primary" style="border: 1px solid #006700; background: #FFFFFF; $ocultar_boton" data-backdrop="static" data-keyboard="false" $btn_ver disabled>
                                        ...
                                        <form onsubmit="enviar_comentarios_add(); return false" id="Add_comentarios" class="col-sm-8">
                                            ...
                                            if ($Administracion[3]['PRORROGA'] == 2) {
                                                ...
                                                $comentario_prorroga = <<<html
                                                    ...
                                                    <button type="submit" name="agregar_resumen" value="enviar_resumen" class="btn btn-primary" style="display: none">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="card card-danger col-md-12">
                                                    <ul class="nav navbar-nav navbar-right">
                                                        <button type="submit" id="terminar_solicitud" name="terminar_solicitud" class="btn btn-success btn-lg" style="background: #2da92d; color: #ffffff; ; display: none" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-md-offset-3">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            <thead>
                                            <tr>
                                                <th colspan="3" style="text-align: center;">Respuestas</th>
                                            </tr>
                                            <tr>
                                                <th style="text-align: center;">Nombre</th>
                                                <th style="text-align: center;">Actividad Económica</th>
