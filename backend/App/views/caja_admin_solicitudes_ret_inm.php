        ...
        <div class="col-md-3 panel panel-body" style="margin-bottom: 0px;">
            ...
            <a id="link" href="/AdminSucursales/SolicitudesRetiroInmediato/">
                <div class="col-md-5" style="margin-top: 5px; margin-left: 0px; border: 1px solid #dfdfdf; border-radius: 10px;">
                    <img src="https://cdn-icons-png.flaticon.com/512/7379/7379556.png" style="border-radius: 3px; padding-top: 5px;" width="110" height="110">
                    <span class="button__badge">4</span>
                    <p style="font-size: 12px; padding-top: 5px; color: #000000"><b>Solicitudes </b></p>
                    <! -- https://cdn-icons-png.flaticon.com/512/7379/7379586.png -->
                </div>
            </a>
                    ...
                    <div class="modal-header" style="padding-bottom: 0px">
                        ...
                        <div>
                            <ul class="nav navbar-nav">
                                <li><a onclick=mostrarAhorro() href=""><p style="font-size: 16px;"><b>Retiro Inmediato</b></p> </a><span class="button__badge_sub">4</span></li>
                                <li class="linea"><a href="/Ahorro/ContratoCuentaCorriente/"><p style="font-size: 15px;">Retiro Periodo</p></a></li>
                                <li class="linea"><a href="/Ahorro/ContratoCuentaCorriente/"><p style="font-size: 15px;">Reimpresión Ticket</p></a></li>
                                <li class="linea"><a href="/Ahorro/ContratoCuentaCorriente/"><p style="font-size: 15px;">Estado de Cuenta</p></a></li>
                                <li class="linea"><a href="/Ahorro/ContratoCuentaCorriente/"><p style="font-size: 15px;">Incidencias</p> </a></li>
                            </ul>
                        </div>
                    </div>
