...
<div class="right_col">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="panel panel-body" style="margin-bottom: 0px;">
            <div class="x_title">
                <h3> Calcular Ajuste de Bono por promoción "Recomienda Más paga Menos"</h3>
            ...
            <div class="card card-danger col-md-5" >
                ...
                <div class="card-body">
                    <form class="" action="/Promociones/Telarana/" method="GET">
                        <div class="row">
                            <div class="col-md-4">
            ...
            <div class="card col-md-12">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_agregar_pago" onclick="BotonPago('<?php echo $Administracion[0]['SITUACION_NOMBRE']; ?>');">
                    <i class="fa fa-download"></i> Descargar Promoción
                </button>
