                        ...
                        <div class="modal-header" style="padding-bottom: 0px">
                            ...
                            <div>
                                <ul class="nav navbar-nav" >
                                    <li><a href="/Ahorro/ContratoInversion/"><p style="font-size: 16px;"><b>Nuevo Contrato de Inversión</b></p></a></li>
                                    <li class="linea"><a href="/Ahorro/ConsultaInversion/"><p style="font-size: 15px;">Consultar Estatus de Inversión</p></a></li>
                                </ul>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" style="resize: none;" class="form-control" id="direccion" name="direccion" rows="3" cols="50" readonly><?php echo $Cliente[0]['DIRECCION']; ?>.
                                                            </textarea>
                                                        </div>
                                                    </div>
