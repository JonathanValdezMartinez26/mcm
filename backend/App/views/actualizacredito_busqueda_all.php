                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <input type="text" class="form-control" id="ciclo_s" name="ciclo_s" aria-describedby="ciclo_s" placeholder="Escribe el cilco"  value="<?php echo $Administracion['CICLO']; ?>" readonly>
                                </div>
                            </div>
