                        ...
                        <div class="modal-header" style="padding-bottom: 0px">
                            ...
                            <div>
                                <ul class="nav navbar-nav" >
                                    <li class="linea"><a href="/Ahorro/ContratoInversion/"><p style="font-size: 15px;">Nuevo Contrato de Inversión</p></a></li>
                                    <li><a href="/Ahorro/ConsultaInversion/"><p style="font-size: 16px;"><b>Consultar Estatus de Inversión</b></p></a></li>
                                </ul>
                            </div>
                        </div>
