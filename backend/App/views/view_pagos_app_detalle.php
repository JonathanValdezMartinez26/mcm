                ...
                <div class="row" >
                    <div class="tile_count float-right col-sm-12" style="margin-bottom: 1px; margin-top: 1px">
                        <div class="col-md-3 col-sm-4  tile_stats_count">
                            ...
                            <span class="count_top badge" style="padding: 1px 1px; background: <?php echo $Administracion[0]['COLOR']; ?>"><h5><b><i class=""><?php echo $ejecutivo; ?></i></b></h5></span>
                        </div>
                        <div class="col-md-2 col-sm-2  tile_stats_count">
                            <span class="count_top" style="font-size: 15px"><i>#</i> de Pagos Validados</span>
                            <div class="count" style="font-size: 30px; color: #030303"><span id="validados_p" name="validados_p" style="font-size: 30px; color: #030303"><?php echo $DetalleGlobal[0]['TOTAL_VALIDADOS']; ?></span> DE <span id="validados_t" name="validados_t" style="font-size: 30px; color: #030303"><?php echo $DetalleGlobal[0]['TOTAL_PAGOS']; ?></span></div>
                        </div>
                        <div class="col-md-3 col-sm-4  tile_stats_count">
