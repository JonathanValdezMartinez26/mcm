        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <span class="badge" style="background: #57687b">
                    <h4 style="margin-top: 4px; margin-bottom: 4px">Datos del Crédito | <i class="fa fa-user"></i> <?php echo $Administracion[0]['CLIENTE']; ?></h4>
                </span>
                                            ...
                                            <tr>
                                                <td style="font-size: 18px; background: #cccccc;color: #707070" colspan="14">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            Usted a registrado <strong>
                                                                <span class="label label-<?php echo $color_titulo_l1_a; ?>" style="font-size: 95% !important; border-radius: 50em !important;" align="right"><?php if ($Administracion[4]['NUMERO_INTENTOS_AV'] == NULL) {
                                                                                                                                                                                                                    $num = '0';
                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                    $num = $Administracion[4]['NUMERO_INTENTOS_AV'];
                                                                                                                                                                                                                }
                                                                                                                                                                                                                echo $num; ?></span> </strong>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form onsubmit="enviar_add_av(); return false" id="Add_av">
                    <center>
                        <h4 class="modal-title"><?php echo $Administracion[0]['AVAL']; ?>, LLAMADA #<label id="titulo_av" name="titulo_av"><?php if ($Administracion[4]['NUMERO_INTENTOS_AV'] == NULL) {
                                                                                                                                                $num = '1';
                                                                                                                                            } else {
                                                                                                                                                $num = $Administracion[4]['NUMERO_INTENTOS_AV'] + 1;
                                                                                                                                            }
                                                                                                                                            echo $num; ?></label></h4>
                    </center>
            </div>
