                                    ...
                                    <div class="row">
                                        <div class="card col-md-12">
                                                <form id="AddPagoApertura">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="col-md-3" style="border: 1px solid #dfdfdf; border-radius: 30px;" data-toggle="modal" data-target="#modal_agregar_pago">
                                                                <br>
                                                                <center>
                                                                    <p style="font-size: 16px"><b><i class="fa fa-sun-o" style="color: #ffdc3a"></i> Iniciaste el día con:</b></p>
                                                                    <br>
                                                                    <p style="font-size: 19px"><b> $50,000.00</b></p>
                                                                </center>
                                                                <br>
                                                            </div>
                                                            <div class="col-md-3" style="border: 1px solid #dfdfdf; border-radius: 30px; " data-toggle="modal" data-target="#modal_agregar_pago">
                                                                ...
                                                                <center>
                                                                    ...
                                                                    <br>
                                                                    <p style="font-size: 19px"><b> $10,000.00</b></p>
                                                                </center>
                                                                <br>
                                                            </div>
                                                            <div class="col-md-3" style="border: 1px solid #dfdfdf; border-radius: 30px;" data-toggle="modal" data-target="#modal_agregar_pago">
                                                                ...
                                                                <center>
                                                                    ...
                                                                    <br>
                                                                    <p style="font-size: 19px"><b> $1,000.00</b></p>
                                                                </center>
                                                                <br>
                                                            </div>
                                                            <div class="col-md-3" style="border: 1px solid #dfdfdf; border-radius: 30px;" data-toggle="modal" data-target="#modal_agregar_pago">
                                                                <br>
                                                                <center>
                                                                    <p style="font-size: 16px"><b><i class="fa fa-moon-o" style="color: #094471"></i> Terminarás el día con:</b></p>
                                                                    <br>
                                                                    <p style="font-size: 19px"><b> $59,000.00</b></p>
                                                                </center>
                                                                <br>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <table class="table table-striped table-bordered table-hover" id="muestra-cupones">
                                                                    ...
                                                                    <tbody>
                                                                        <tr style="padding: 0px !important;" role="row" class="odd">
                                                                            <td style="padding: 0px !important;" width="45" nowrap="" onclick="InfoAdmin();"><span class="count_top" style="font-size: 22px"><i class="fa fa-arrow-down" style="color: #21ac29"></i></span></td>
                                                                            <td style="padding: 0px !important;">COBRO AHORRO PEQUE</td>
                                                                            <td style="padding: 0px !important;">EJEMPLO EJEMPLO EJEMPLO</td>
                                                                            <td style="padding: 0px !important;" width="45" nowrap="">003011</td>
                                                                            <td style="padding: 0px !important;">15/03/2024 12:24:04</td>
                                                                            <td style="padding: 0px !important;">$ 2500.00</td>
                                                                            <td style="padding: 0px !important;">HUELLA</td>
                                                                        </tr>
                                                                        <tr style="padding: 0px !important;" role="row" class="odd">
                                                                            <td style="padding: 0px !important;" width="45" nowrap="" onclick="InfoAdmin();"><span class="count_top" style="font-size: 22px"><i class="fa fa-arrow-down" style="color: #21ac29"></i></span></td>
                                                                            <td style="padding: 0px !important;">COBRO AHORRO CORRIENTE</td>
                                                                            <td style="padding: 0px !important;">EJEMPLO EJEMPLO EJEMPLO</td>
                                                                            <td style="padding: 0px !important;" width="45" nowrap="">003011</td>
                                                                            <td style="padding: 0px !important;">15/03/2024 12:24:04</td>
                                                                            <td style="padding: 0px !important;">$ 2500.00</td>
                                                                        ...
                                                                        <tr style="padding: 0px !important;" role="row" class="odd">
                                                                            <td style="padding: 0px !important;" width="45" nowrap="" onclick="InfoAdmin();"><span class="count_top" style="font-size: 19px"><i class="fa fa-minus-square" style="color: #b5ff68"></i></span></td>
                                                                            <td style="padding: 0px !important;">INVERSION AHORRO</td>
                                                                            <td style="padding: 0px !important;">EJEMPLO EJEMPLO EJEMPLO</td>
                                                                            <td style="padding: 0px !important;" width="45" nowrap="">003011</td>
                                                                            <td style="padding: 0px !important;">15/03/2024 12:24:04</td>
                                                                            <td style="padding: 0px !important;">$ 2500.00</td>
                                                                        ...
                                                                        <tr style="padding: 0px !important;" role="row" class="odd">
                                                                            <td style="padding: 0px !important;" width="45" nowrap="" onclick="InfoAdmin();"><span class="count_top" style="font-size: 22px"><i class="fa fa-arrow-up" style="color: #d1000d"></i></span></td>
                                                                            <td style="padding: 0px !important;">RETIRO AHORRO PEQUE</td>
                                                                            <td style="padding: 0px !important;">EJEMPLO EJEMPLO EJEMPLO</td>
                                                                            <td style="padding: 0px !important;" width="45" nowrap="">003011</td>
                                                                            <td style="padding: 0px !important;">15/03/2024 12:24:04</td>
                                                                            <td style="padding: 0px !important;">$ 2500.00</td>
