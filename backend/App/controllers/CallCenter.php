            ...
            foreach ($Solicitudes as $key => $value) {
               if($value['ESTATUS_CL'] == 'PENDIENTE')
                ...
                <tr style="padding: 0px !important;">
                    ...
                    <td style="padding-top: 10px !important;"><span class="fa fa-user"></span> <label style="color: #1c4e63">{$value['NOMBRE']}</label> <br><label><span class="fa fa-phone"></span> {$value['TEL_CL']}</label></td>
