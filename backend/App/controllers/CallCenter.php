...
html;
        ...
        if ($Inicial != '' || $Final != '') {
            /////////////////////////////////
            $Consulta = CallCenterDao::getAllSolicitudesHistorico($Inicial, $Final, $cdgco, $this->__perfil);
...
html;
            ...
            $Consulta = CallCenterDao::getAllSolicitudesHistorico($fechaActual, $fechaActual, $cdgco, $this->__perfil);
